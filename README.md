...
**[Budget App]** A budget app is a tool designed to help individuals or households manage their finances by tracking income and expenses. With features like expense categorization, and expenses tracking, budget apps can be a useful way to improve financial management and achieve financial goals.
...
- Add your Categories for expenses
- Add new transactions for each category
- Get the total per category for each category
- Can have many users to use the app

## 🚀 Live Demo <a name="live-demo"></a>

[Live Demo Link](https://rails-budget-app-s2ql.onrender.com/)
